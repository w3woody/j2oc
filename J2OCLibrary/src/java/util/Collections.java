...
import com.chaosinmotion.j2oclibrary.rtl.Array;
        ...
        private static class UnmodifiableEntrySet<K, V> extends
            ...
            public <T> T[] toArray(T[] contents) {
                ...
                if (size > contents.length) {
                    contents = (T[])Array.createRefArray(size);
...
//                    contents = (T[]) Array.newInstance(ct, size);
    ...
    static <E> E checkType(E obj, Class<E> type) {
        if (!type.isInstance(obj)) {
            ...
            // element type {1}
            throw new ClassCastException(); //$NON-NLS-1$
        }
        return obj;
    }
        ...
        private static class CheckedEntrySet<K, V> implements
            ...
            public <T> T[] toArray(T[] array) {
                ...
                if (array.length < thisSize) {
                    array = (T[])Array.createRefArray(thisSize);
