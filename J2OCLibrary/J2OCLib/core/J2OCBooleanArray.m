...
@implementation J2OCBooleanArray
...
// not boolAtIndex, since JVM uses byte and bool
...
- (java_lang_Object *)clone__
{
	int i;
	
	J2OCBooleanArray *tmp = [[[J2OCBooleanArray alloc] initArrayWithSize:length] autorelease];
	for (i = 0; i < length; ++i) {
		(tmp->array)[i] = array[i];
	}
	return tmp;
